...
export default function App() {
  ...
  const [settings, setSettings] = useState<Settings>({
    ...
    forceUpdateVersionLabel: '1.0.16',
        ...
        {isForceUpdateScreen ? (
          <div className="min-h-screen flex items-center justify-center px-4 py-16">
            <div className="max-w-xl w-full text-center bg-slate-900/80 border border-emerald-500/30 rounded-3xl p-8 sm:p-12 shadow-2xl shadow-emerald-950/30">
              ...
              <p className="mt-3 text-slate-400 leading-7">Version {settings.forceUpdateVersionLabel || 'latest'} is required to continue using NovaEsp Shop.</p>
