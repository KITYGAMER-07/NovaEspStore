  ...
  return (
    <div className="py-8 max-w-7xl mx-auto px-4 sm:px-6">
      ...
      {activeTab === 'apk-links' && (
        <div className="space-y-6">
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 space-y-5">
            <div><h3 className="text-base font-bold text-white flex items-center gap-2"><Download className="w-5 h-5 text-emerald-400" /> Product APK Downloads</h3><p className="text-xs text-slate-400 mt-1">Upload APK files directly to Supabase or add unlimited product APK download links. Uploaded APKs appear automatically on purchase, trial and order lookup pages.</p></div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
