      ...
      >
        ...
        >
          ...
          <p className="mt-1.5 text-xs sm:text-sm text-slate-400 max-w-md mx-auto">
            {order.orderType === 'prebooking' ? 'Your full payment has been received. Your reservation is secured. Keep your Booking ID and use Track Order to check the release status.' : 'Thank you for your purchase. Your digital license key is active and ready below.'}
          </p>
        </motion.div>
        </div>
