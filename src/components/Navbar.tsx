    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/90 border-b border-slate-800/80 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="relative flex items-center justify-center w-11 h-11 rounded-2xl overflow-hidden bg-slate-900 border border-slate-700/80 group-hover:scale-105 transition-all duration-300">
              <img 
                src="/logo.jpg" 
                alt="NovaKey Logo" 
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-extrabold text-xl tracking-tight text-white group-hover:text-emerald-400 transition-colors">
                  Nova<span className="text-emerald-400">Key</span>
                </span>
