            ...
            {!claimedTrialResult ? (
              ...
              >
                ...
                <button
                  ...
                  className="w-full mb-3 flex items-center justify-center gap-2 py-3 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-300 font-bold text-xs border border-amber-500/30 transition-all active:scale-[0.98]"
                >
