...
export const StoreFront: React.FC<StoreFrontProps> = ({
  ...
  // Keep the page behind the trial modal fixed. Only the modal content scrolls.
  useEffect(() => {
    ...
    <div className="relative py-8 sm:py-12 overflow-x-hidden">
      ...
      {showTrialModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn overscroll-contain">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-lg w-full max-h-[calc(100vh-2rem)] overflow-y-auto overscroll-contain shadow-2xl relative">
            ...
            {!claimedTrialResult ? (
              ...
              >
                ...
                {/* APK Download Box - stacked layout to match the purchase success page */}
                <motion.div 
                  initial={{ opacity: 0, y: 15 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex flex-col gap-4">
                    <div className="flex items-start gap-3 min-w-0 w-full">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h4 className="text-sm font-bold text-white leading-tight">{apkAppName}</h4>
                        ...
                        <p className="text-xs text-slate-400 mt-1 leading-relaxed">Download Android Loader to activate key</p>
                      </div>
                    </div>
                    ...
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-teal-400 hover:bg-teal-300 text-slate-950 font-bold text-xs shadow-lg shadow-teal-500/20 transition-all active:scale-[0.98]"
                    >
                    ...
                    {setupChannelUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs border border-slate-700 transition-all active:scale-[0.98]"
                      >
