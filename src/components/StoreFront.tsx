  ...
  return (
    <div className="relative py-8 sm:py-12 overflow-x-hidden">
      ...
      {showDemoGatewayModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn overscroll-contain">
      ...
      {showTrialModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-5 bg-slate-950/90 backdrop-blur-md animate-fadeIn overscroll-none">
          <div className="relative flex w-full max-w-lg max-h-[calc(100dvh-1.5rem)] sm:max-h-[calc(100dvh-2.5rem)] flex-col overflow-hidden rounded-3xl bg-slate-900 border border-emerald-500/20 shadow-2xl shadow-black/60">
            <div className="shrink-0 px-5 sm:px-7 pt-5 sm:pt-7 pb-3 border-b border-slate-800/70 bg-slate-900/95">
            
              <div className="flex items-center justify-between pr-10">
                <div>
                  <p className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-emerald-400">NovaEsp Free Trial</p>
                  <p className="text-xs text-slate-400 mt-1">Secure trial activation portal</p>
                </div>
                <button
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-5 sm:px-7 py-5 sm:py-6 [scrollbar-width:thin]">
            {!claimedTrialResult ? (
              ...
              >
                ...
                {setupChannelUrl && (
                  <a
                    href={setupChannelUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full mb-3 py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs transition-all active:scale-[0.98] flex items-center justify-center"
                  >
                    Setup Guide
                  </a>
                )}
            ...
            <div className="shrink-0 border-t border-slate-800/70 px-5 sm:px-7 py-3 bg-slate-900/95 text-center">
              <p className="text-[10px] text-slate-500">Keep this window open until you finish downloading your files.</p>
            </div>
          </div>
        </div>
      )}
