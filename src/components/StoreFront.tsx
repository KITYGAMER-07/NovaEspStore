...
export const StoreFront: React.FC<StoreFrontProps> = ({
  ...
  return (
    <div className="relative py-8 sm:py-12 overflow-x-hidden">
      ...
      {showTrialModal && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-y-auto p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn overscroll-contain">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-lg w-full max-h-[calc(100vh-2rem)] overflow-y-auto overscroll-contain shadow-2xl relative my-2 sm:my-4">
                  ...
                  {showTrialRules && (
                    ...
                    >
                      <motion.div
                        ...
                        className="w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl bg-slate-950 border border-amber-500/30 shadow-2xl p-5 sm:p-6 text-left"
                      >
