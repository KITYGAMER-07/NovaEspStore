...
export const OrderLookup: React.FC<OrderLookupProps> = ({ orders }) => {
                ...
                >
                  ...
                  <div className="bg-slate-950 p-3.5 rounded-xl border border-slate-800 flex items-center justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      <code className="font-mono text-sm font-bold text-emerald-400 break-all select-all">
                        {isKeyShown ? ord.licenseKey : '••••••••-••••••••-••••••••'}
                      </code>
                    </div>
